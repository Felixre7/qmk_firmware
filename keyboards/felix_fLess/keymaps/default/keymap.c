...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* 0: QWERTT */
    [_BL] = KEYMAP(
           ...
           KC_LCTL, KC_LGUI, KC_LALT,                    KC_SPC,                          KC_RALT,  KC_RCTL,           KC_LEFT, KC_DOWN,  KC_RIGHT , KC_P0,            KC_PDOT,   F(0)),
  /* 1: FN 1 */
     [_FL] = KEYMAP(
...
const uint16_t PROGMEM fn_actions[] = {
    [0] = ACTION_LAYER_TAP_KEY(_FL, KC_PENT),  // to second layer if held
    [1] = ACTION_LAYER_MOMENTARY(_FL),     // toggle GRV f-keys*/
};

  qk_tap_dance_action_t tap_dance_actions[]={
    [0] =  ACTION_TAP_DANCE_DUAL_ROLE(KC_PENT, _FL)
  };
